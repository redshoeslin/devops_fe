<template>
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增工单' : '编辑apk工单'" width="550px">
    <el-form ref="apkform" :model="form" :rules="rules" size="small" label-width="100px">
      ...
      <el-form-item label="App_style" prop="password">
        <el-select v-model="form.password" style="width: 370px;" placeholder="请选择Build版本">
          <el-option v-for="item in service_types" :key="item.key" :label="item.value" :value="item.value"/>
        </el-select>
      </el-form-item>
      -->
