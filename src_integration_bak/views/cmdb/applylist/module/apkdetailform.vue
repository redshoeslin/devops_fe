<template>
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="'apk工单详情'" width="550px">
    ...
    <div :model="form">
      ...
      <p>build_variant:{{ form.build_variant }}</p>
      <p>build_version:{{ form.build_version }}</p>
      <p>app_stype:{{ form.app_stype }}</p>
    </div>
  </el-dialog>
</template>
