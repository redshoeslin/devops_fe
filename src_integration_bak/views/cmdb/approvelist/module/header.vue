  ...
  <div class="head-container">
    ...
    <div style="display: inline-block;margin: 10px 2px;">
      <el-button-group>
        ...
        <!--
        <el-button v-if="checkPermission(['admin','connection_all', 'connection_create'])" class="filter-item" size="mini" type="primary" @click="add">创建工单</el-button>
        -->
      </el-button-group>
  ...
  methods: {
    ...
    download() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['ID', 'git repo url', '认证类型', '用户名', '密码', '端口', '备注']
