    ...
    <div class="head-container">
      ...
      <div style="display: inline-block;margin: 0px 2px;">
        <el-button
          ...
          type="primary"
          icon="el-icon-plus"
          @click="toCreate">新增前端模块</el-button>
      </div>
      <eForm ref="form" :is-add="true" :item_types="item_types"/>
      <div style="display: inline-block;margin: 0px 2px;">
        <el-button
          v-if="checkPermission(['admin','project_all','project_create'])"
          class="filter-item"
          ...
          type="primary"
          icon="el-icon-plus"
          @click="toCreatebe">新增后端模块</el-button>
      </div>
      <beForm ref="beform" :is-add="true" :item_types="item_types"/>
    </div>
    <div class="tab-container">
      <Tables :sup_this="sup_this" :item_types="item_types"/>
    </div>
  </div>
</template>
...
import beForm from './module/beform'
export default {
  components: { Tables, eForm, beForm },
  mixins: [initData],
  data() {
    return {
      sup_this: this,
