<template>
  <div :class="{selected: selected}" :style="style" class="vue-block">
    <header :style="headerStyle">
      {{ title }}
      <a class="delete" @click="deleteBlock">x</a>
    </header>
    <div class="inputs">
      <div v-for="(slot, index) in inputs" :key="slot.active" class="input">
        <div
    ...
    <div class="outputs">
      <div v-for="(slot, index) in outputs" :key="slot.active" class="output">
        <div
          :class="{active: slot.active}"
          class="circle"
